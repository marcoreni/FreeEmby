            ...
            libraryBrowser = {
                ...
                renderDetailPageBackdrop: function(page, item, imageLoader) {
                    var imgUrl, screenWidth = screen.availWidth,
                        ...
                        usePrimaryImage = "Episode" === item.Type;
                    return usePrimaryImage = !1, usePrimaryImage && item.ImageTags && item.ImageTags.Primary ? (imgUrl = ApiClient.getScaledImageUrl(item.Id, {
                        type: "Primary",
                        index: 0,
