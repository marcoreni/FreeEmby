define(["events", "loading"], function(events, loading) {
    ...
    function loadTemplate(page, type, providerId) {
        ...
        xhr.open("GET", "components/tvproviders/" + type + ".template.html", !0), xhr.onload = function(e) {
            var html = this.response,
                elem = page.querySelector(".providerTemplate");
            elem.innerHTML = Globalize.translateDocument(html), init(page, type, providerId)
        }, xhr.send()
    }
