define(["jQuery", "loading", "emby-checkbox", "listViewStyle", "emby-input", "emby-select"], function($, loading) {
    ...
    return function(page, providerId, options) {
        ...
        function submitLoginForm() {
            loading.show(), require(["cryptojs-sha1"], function() {
                var info = {
        ...
        function refreshListings(value) {
            return value ? (loading.show(), void ApiClient.ajax({
                type: "GET",
        ...
        self.submit = function() {
            ...
            }), $(".createAccountHelp", page).html(Globalize.translate("MessageCreateAccountAt", '<a href="http://www.schedulesdirect.org" target="_blank">http://www.schedulesdirect.org</a>')), reload()
        }
    }
});