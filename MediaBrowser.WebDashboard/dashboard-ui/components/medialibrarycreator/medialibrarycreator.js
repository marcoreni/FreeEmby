define(["loading", "dialogHelper", "dom", "jQuery", "components/libraryoptionseditor/libraryoptionseditor", "emby-input", "emby-select", "paper-icon-button-light", "listViewStyle", "formDialogStyle"], function(loading, dialogHelper, dom, $, libraryoptionseditor) {
    ...
    function initEditor(page, collectionTypeOptions) {
        ...
        }), page.querySelector(".btnAddFolder").addEventListener("click", onAddButtonClick), page.querySelector("form").addEventListener("submit", onSubmit), page.querySelector(".folderList").addEventListener("click", onRemoveClick)
    }
    ...
    function getFolderHtml(pathInfo, index) {
        var html = "";
        html += '<div class="listItem lnkPath">', html += '<i class="listItemIcon md-icon">folder</i>';
        var cssClass = pathInfo.NetworkPath ? "listItemBody two-line" : "listItemBody";
        return html += '<div class="' + cssClass + '">', html += '<div class="listItemBodyText">' + pathInfo.Path + "</div>", pathInfo.NetworkPath && (html += '<div class="listItemBodyText secondary">' + pathInfo.NetworkPath + "</div>"), html += "</div>", html += '<button type="button" is="paper-icon-button-light"" class="listItemButton btnRemovePath" data-index="' + index + '"><i class="md-icon">remove_circle</i></button>', html += "</div>"
    }
