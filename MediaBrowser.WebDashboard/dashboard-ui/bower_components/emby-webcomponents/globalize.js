define(["connectionManager", "userSettings", "events"], function(connectionManager, userSettings, events) {
    ...
    function getDefaultLanguage() {
        ...
        return culture ? culture : navigator.language ? navigator.language : navigator.userLanguage ? navigator.userLanguage : navigator.languages && navigator.languages.length ? navigator.languages[0] : "en-us"
    }
    ...
    function updateCurrentCulture() {
        ...
        culture = culture || getDefaultLanguage(), currentCulture = normalizeLocaleName(culture), ensureTranslations(currentCulture)
    }
    ...
    function loadTranslation(translations, lang) {
        ...
        return filtered.length || (filtered = translations.filter(function(t) {
            ...
            url += url.indexOf("?") === -1 ? "?" : "&", url += "v=" + cacheParam;
    ...
    var currentCulture, _defaultModule, allTranslations = {},
    ...
    return updateCurrentCulture(), events.on(connectionManager, "localusersignedin", updateCurrentCulture), events.on(userSettings, "change", function(e, name) {
        "language" === name && updateCurrentCulture()
    }), {
        getString: translate,
        translate: translate,
