define(["layoutManager", "browser", "css!./emby-textarea", "registerElement"], function(layoutManager, browser) {
    ...
    function autoGrow(textarea, maxLines) {
        ...
        function autogrowFn() {
            ...
            var newHeight = 0,
                hasGrown = !1;
            textarea.scrollHeight - offset > self.maxAllowedHeight ? (textarea.style.overflowY = "scroll", newHeight = self.maxAllowedHeight) : (textarea.style.overflowY = "hidden", textarea.style.height = "auto", newHeight = textarea.scrollHeight, hasGrown = !0), textarea.style.height = newHeight + "px"
        }
        var self = this;
    ...
    if (Object.getOwnPropertyDescriptor && Object.defineProperty) {
        ...
        if (descriptor && descriptor.configurable) {
            ...
            }, Object.defineProperty(HTMLTextAreaElement.prototype, "value", descriptor), supportsFloatingLabel = !0
        }
    }
    EmbyTextAreaPrototype.createdCallback = function() {
        ...
        if (!this.classList.contains("emby-textarea")) {
            ...
            label.innerHTML = this.getAttribute("label") || "", label.classList.add("textareaLabel"), supportsFloatingLabel && "date" !== this.type || label.classList.add("nofloat"), label.htmlFor = this.id, parentNode.insertBefore(label, this);
            var div = document.createElement("div");
            div.classList.add("emby-textarea-selectionbar"), parentNode.insertBefore(div, this.nextSibling), this.addEventListener("focus", function() {
