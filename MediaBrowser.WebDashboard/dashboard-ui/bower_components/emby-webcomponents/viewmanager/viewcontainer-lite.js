define(["browser", "dom", "layoutManager", "css!./viewcontainer-lite"], function(browser, dom, layoutManager) {
    ...
    function enableAnimation() {
        return !browser.tv && (!forceDisableAnimation && browser.supportsCssAnimation())
    }
