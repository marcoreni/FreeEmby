require(["apphost"], function(appHost) {
    ...
    function raiseKeyEvent(oldPressedState, newPressedState, key, keyCode, enableRepeatKeyDown, clickonKeyUp) {
        if (newPressedState === !0) {
            var fire = !1;
            oldPressedState === !1 ? (fire = !0, resetThrottle(key)) : enableRepeatKeyDown && (fire = throttle(key)), fire && keyCode && raiseEvent("keydown", key, keyCode)
        } else newPressedState === !1 && oldPressedState === !0 && (resetThrottle(key), keyCode && raiseEvent("keyup", key, keyCode), clickonKeyUp && clickElement(document.activeElement || window))
    }
    ...
    _ButtonPressedState.getgamepadA = function() {
        ...
        raiseKeyEvent(_gamepadAPressed, newPressedState, _GAMEPAD_A_KEY, _GAMEPAD_A_KEYCODE, !1, !0), _gamepadAPressed = newPressedState
    }, _ButtonPressedState.getgamepadB = function() {
        return _gamepadBPressed
    }, _ButtonPressedState.setgamepadB = function(newPressedState) {
        raiseKeyEvent(_gamepadBPressed, newPressedState, _GAMEPAD_B_KEY, _GAMEPAD_B_KEYCODE), _gamepadBPressed = newPressedState
        ...
        raiseKeyEvent(_leftThumbstickUpPressed, newPressedState, _GAMEPAD_LEFT_THUMBSTICK_UP_KEY, _GAMEPAD_LEFT_THUMBSTICK_UP_KEYCODE, !0), _leftThumbstickUpPressed = newPressedState
        ...
        raiseKeyEvent(_leftThumbstickDownPressed, newPressedState, _GAMEPAD_LEFT_THUMBSTICK_DOWN_KEY, _GAMEPAD_LEFT_THUMBSTICK_DOWN_KEYCODE, !0), _leftThumbstickDownPressed = newPressedState
        ...
        raiseKeyEvent(_leftThumbstickLeftPressed, newPressedState, _GAMEPAD_LEFT_THUMBSTICK_LEFT_KEY, _GAMEPAD_LEFT_THUMBSTICK_LEFT_KEYCODE, !0), _leftThumbstickLeftPressed = newPressedState
        ...
        raiseKeyEvent(_leftThumbstickRightPressed, newPressedState, _GAMEPAD_LEFT_THUMBSTICK_RIGHT_KEY, _GAMEPAD_LEFT_THUMBSTICK_RIGHT_KEYCODE, !0), _leftThumbstickRightPressed = newPressedState
    }, _ButtonPressedState.getdPadUp = function() {
        return _dPadUpPressed
    }, _ButtonPressedState.setdPadUp = function(newPressedState) {
        raiseKeyEvent(_dPadUpPressed, newPressedState, _GAMEPAD_DPAD_UP_KEY, _GAMEPAD_DPAD_UP_KEYCODE, !0), _dPadUpPressed = newPressedState
    }, _ButtonPressedState.getdPadDown = function() {
        return _dPadDownPressed
    }, _ButtonPressedState.setdPadDown = function(newPressedState) {
        raiseKeyEvent(_dPadDownPressed, newPressedState, _GAMEPAD_DPAD_DOWN_KEY, _GAMEPAD_DPAD_DOWN_KEYCODE, !0), _dPadDownPressed = newPressedState
    }, _ButtonPressedState.getdPadLeft = function() {
        return _dPadLeftPressed
    }, _ButtonPressedState.setdPadLeft = function(newPressedState) {
        raiseKeyEvent(_dPadLeftPressed, newPressedState, _GAMEPAD_DPAD_LEFT_KEY, _GAMEPAD_DPAD_LEFT_KEYCODE, !0), _dPadLeftPressed = newPressedState
        ...
        raiseKeyEvent(_dPadRightPressed, newPressedState, _GAMEPAD_DPAD_RIGHT_KEY, _GAMEPAD_DPAD_RIGHT_KEYCODE, !0), _dPadRightPressed = newPressedState
    };
    var times = {};
