define(["apphost", "globalize", "connectionManager", "layoutManager", "shell", "focusManager", "scrollHelper", "appSettings", "registrationServices", "dialogHelper", "paper-icon-button-light", "formDialogStyle"], function(appHost, globalize, connectionManager, layoutManager, shell, focusManager, scrollHelper, appSettings, registrationServices, dialogHelper) {
    ...
    function renderFormInternal(options, appInfo, resolve) {
        var elem = options.elem,
            ...
            html = "",
            targetContainerClass = options.isLocalSync ? " hide" : "";
        (options.showName || dialogOptions.Options.indexOf("Name") !== -1) && (html += '<h1 style="margin-top:0;" class="syncJobName ' + targetContainerClass + '"></h1>');
        ...
        lnkLearnMore && lnkLearnMore.addEventListener("click", onHelpLinkClick), setTimeout(function() {
    ...
    function enableAutoSync(options) {
        if (!options.isLocalSync) return !1;
    ...
    function onQualityChange(form, qualityId) {
        ...
        option ? qualityDescription.innerHTML = option.Description || "" : qualityDescription.innerHTML = "";
