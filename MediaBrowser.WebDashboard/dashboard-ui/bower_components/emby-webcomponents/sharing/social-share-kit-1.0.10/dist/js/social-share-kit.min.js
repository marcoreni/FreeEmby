...
var SocialShareKit = function() {
    ...
    function s(e, t, n) {
        var o, r = f(e, t, n),
            i = d(e, t, n, r),
            a = "undefined" != typeof r.title ? r.title : l(t),
            c = "undefined" != typeof r.text ? r.text : p(t),
            u = r.image ? r.image : h("og:image"),
            s = "undefined" != typeof r.via ? r.via : h("twitter:site"),
            m = {
                shareUrl: i,
                title: a,
                text: c,
        ...
        switch (t) {
            case "facebook":
                ...
                break;
            case "twitter":
                o = "https://twitter.com/intent/tweet?url=" + m.shareUrlEncoded() + "&text=" + encodeURIComponent(a + (c && a ? " - " : "") + c), s && (o += "&via=" + s.replace("@", ""));
                break;
            case "google-plus":
                o = "https://plus.google.com/share?url=" + m.shareUrlEncoded();
                break;
            case "pinterest":
                o = "https://pinterest.com/pin/create/button/?url=" + m.shareUrlEncoded() + "&description=" + encodeURIComponent(c), u && (o += "&media=" + encodeURIComponent(u));
                break;
            case "tumblr":
    ...
    function l(e) {
        var t;
        return "twitter" == e && (t = h("twitter:title")), t || document.title
    }

    function p(e) {
        var t;
        return "twitter" == e && (t = h("twitter:description")), t || h("description")
    }
    ...
    function f(e, t, n) {
        ...
        for (a in c) r = c[a], i = "data-" + r, o = n.getAttribute(i) || s.getAttribute(i) || (e[t] && "undefined" != typeof e[t][r] ? e[t][r] : e[r]), "undefined" != typeof o && (u[r] = o);
        return u
    }
    ...
    var k, b, y = /(twitter|facebook|google-plus|pinterest|tumblr|vk|linkedin|email)/,
        C = "*|*";
    return b = function(e) {
        var t = e || {},
            o = t.selector || ".ssk";
        ...
        share: function() {
            function e(e) {
                ...
                if (o && (t = s(p, r, n))) {
                    ...
                    if ("email" != r) {
                        var i = u(t);
                        if (p.onOpen && p.onOpen(n, r, t, i), p.onClose) var d = window.setInterval(function() {
                            i.closed !== !1 && (window.clearInterval(d), p.onClose(n, r, t, i))
                        }, 250)
            ...
            var l = this.nodes,
                ...
                h = {};
            return t(function() {
                l.length && (o(l, function(t) {
                    var n, o = a(t);
                    o && (i(t, "click", e), r(t, "click", e), t.parentNode.className.indexOf("ssk-count") !== -1 && (o = o[0], n = o + C + d(p, o, t), n in h || (h[n] = []), h[n].push(t)))
                }), n())
            }), this.nodes
        }
    }, k = function(e) {
