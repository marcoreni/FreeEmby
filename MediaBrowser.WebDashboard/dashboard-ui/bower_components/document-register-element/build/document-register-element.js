! function(e, t, n, r) {
    ...
    function it(e) {
        for (var r, t = 0, n = e.length; t < n; t++) r = e[t], nt(r, b[ot(r)])
    }
    ...
    function at(e) {
        var t = e.currentTarget,
            ...
            r = e.attrName,
            i = e.target;
        Q && (!i || i === t) && t.attributeChangedCallback && "style" !== r && e.prevValue !== e.newValue && t.attributeChangedCallback(r, n === e[a] ? null : e.prevValue, n === e[l] ? null : e.newValue)
    }
    ...
    function vt(e, t) {
        var n, r = ot(e); - 1 < r && (tt(e, b[r]), r = 0, t !== s || e[s] ? t === o && !e[o] && (e[s] = !1, e[o] = !0, r = 1) : (e[o] = !1, e[s] = !0, r = 1, B && S.call(F, e) < 0 && F.push(e)), r && (n = e[t + "Callback"]) && n.call(e))
    }
    if (!(r in t)) {
        var X, G, Y, Z, et, tt, nt, i = "__" + r + (1e5 * Math.random() >> 0),
            s = "attached",
            o = "detached",
            u = "extends",
            a = "ADDITION",
        ...
        O || M ? (tt = function(e, t) {
            ...
            var e = k(H, "addEventListener"),
                ...
                s = function(e) {
                    ...
                    n.hasOwnProperty(r) && (n = n[r], s = new CustomEvent(c, {
                        bubbles: !0
                    }), s.attrName = n.name, s.prevValue = n.value || null, s.newValue = n.value = t[r] || null, null == s.prevValue ? s[a] = s.attrChange = 0 : s[f] = s.attrChange = 1, t.dispatchEvent(s))
                };
            ...
            for (var t, n, r = {}, i = e.attributes, s = 0, o = i.length; s < o; s++) t = i[s], n = t.name, "setAttribute" !== n && (r[n] = t.value);
            return r
        })), t[r] = function(n, r) {
            if (c = n.toUpperCase(), $ || ($ = !0, P ? (et = function(e, t) {
                    function n(e, t) {
                        for (var n = 0, r = e.length; n < r; t(e[n++]));
                    }
                    return new P(function(r) {
                        for (var i, s, o, u = 0, a = r.length; u < a; u++) i = r[u], "childList" === i.type ? (n(i.addedNodes, e), n(i.removedNodes, t)) : (s = i.target, Q && s.attributeChangedCallback && "style" !== i.attributeName && (o = s.getAttribute(i.attributeName), o !== i.oldValue && s.attributeChangedCallback(i.attributeName, i.oldValue, o)))
                    })
                }(st(s), st(o)), et.observe(t, {
                    childList: !0,
                    subtree: !0
                })) : (X = [], V(function E() {
                    for (; X.length;) X.shift().call(null, X.shift());
                    V(E)
                ...
                }), -2 < S.call(y, v + c) + S.call(y, d + c) && dt(n), !m.test(c) || -1 < S.call(g, c)) throw new Error("The type " + n + " is invalid");
            var c, p, i = function() {
