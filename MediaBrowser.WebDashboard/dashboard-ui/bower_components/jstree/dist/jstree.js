    ...
    if (!$.jstree) {
        ...
        _node.setAttribute("role", "treeitem"), _temp1 = document.createElement("I"), _temp1.className = "jstree-icon jstree-ocl", _temp1.setAttribute("role", "presentation"), _node.appendChild(_temp1), _temp1 = document.createElement("A"), _temp1.className = "jstree-anchor", _temp1.setAttribute("href", "#"), _temp1.setAttribute("tabindex", "-1"), _temp2 = document.createElement("I"), _temp2.className = "jstree-icon jstree-themeicon", _temp2.setAttribute("role", "presentation"), _temp1.appendChild(_temp2), _node.appendChild(_temp1), _temp1 = _temp2 = null, $.jstree = {
            ...
            var is_method = "string" == typeof arg,
                ...
                result = null;
            return !(arg === !0 && !this.length) && (this.each(function() {
                var instance = $.jstree.reference(this),
                    method = is_method && instance ? instance[arg] : null;
                if (result = is_method && method ? method.apply(instance, args) : null, instance || is_method || arg !== undefined && !$.isPlainObject(arg) || $.jstree.create(this, arg), (instance && !is_method || arg === !0) && (result = instance || !1), null !== result && result !== undefined) return !1
                ...
                this.element.on("dblclick.jstree", function() {
                    ...
                    switch (this._data.core.rtl && (37 === e.which ? e.which = 39 : 39 === e.which && (e.which = 37)), e.which) {
                        ...
                        case 13:
                            ...
                            break;
                        case 37:
                            e.preventDefault(), this.is_open(e.currentTarget) ? this.close_node(e.currentTarget) : (o = this.get_parent(e.currentTarget), o && "#" !== o.id && this.get_node(o, !0).children(".jstree-anchor").focus());
                            break;
                        case 38:
                        ...
                        case 39:
                            ...
                            }) : this.is_open(e.currentTarget) && (o = this.get_node(e.currentTarget, !0).children(".jstree-children")[0], o && $(this._firstChild(o)).children(".jstree-anchor").focus());
                            break;
                        case 40:
            ...
            get_path: function(obj, glue, ids) {
                if (obj = obj.parents ? obj : this.get_node(obj), !obj || "#" === obj.id || !obj.parents) return !1;
                var i, j, p = [];
            ...
            get_next_dom: function(obj, strict) {
                ...
                if (strict) {
                    tmp = obj[0];
                    do tmp = this._nextSibling(tmp); while (tmp && 0 === tmp.offsetHeight);
                    return !!tmp && $(tmp)
                }
            ...
            get_prev_dom: function(obj, strict) {
                ...
                if (strict) {
                    tmp = obj[0];
                    do tmp = this._previousSibling(tmp); while (tmp && 0 === tmp.offsetHeight);
                    return !!tmp && $(tmp)
                }
                tmp = obj[0];
                do tmp = this._previousSibling(tmp); while (tmp && 0 === tmp.offsetHeight);
                ...
                return tmp = obj[0].parentNode.parentNode, !(!tmp || !tmp.className || tmp.className.indexOf("jstree-node") === -1) && $(tmp)
            },
            get_parent: function(obj) {
                return obj = this.get_node(obj), !(!obj || "#" === obj.id) && obj.parent
            },
            ...
            is_parent: function(obj) {
                return obj = this.get_node(obj), obj && (obj.state.loaded === !1 || obj.children.length > 0)
            },
            is_loaded: function(obj) {
                return obj = this.get_node(obj), obj && obj.state.loaded
            },
            is_loading: function(obj) {
                return obj = this.get_node(obj), obj && obj.state && obj.state.loading
            },
            is_open: function(obj) {
                return obj = this.get_node(obj), obj && obj.state.opened
            },
            is_closed: function(obj) {
                return obj = this.get_node(obj), obj && this.is_parent(obj) && !obj.state.opened
            },
            ...
            load_node: function(obj, callback) {
                ...
                if (obj = this.get_node(obj), !obj) return callback && callback.call(this, obj, !1), !1;
                if (obj.state.loaded) {
            ...
            load_all: function(obj, callback) {
                if (obj || (obj = "#"), obj = this.get_node(obj), !obj) return !1;
                var i, j, to_load = [],
                    m = this._model.data,
            ...
            _load_node: function(obj, callback) {
                ...
                return s ? $.isFunction(s) ? s.call(this, obj, $.proxy(function(d) {
                    d === !1 && callback.call(this, !1), this["string" == typeof d ? "_append_html_data" : "_append_json_data"](obj, "string" == typeof d ? $($.parseHTML(d)).filter(function() {
                    ...
                    return type && type.indexOf("json") !== -1 || "object" == typeof d ? this._append_json_data(obj, d, function(status) {
                        callback.call(this, status)
                    }) : type && type.indexOf("html") !== -1 || "string" == typeof d ? this._append_html_data(obj, $($.parseHTML(d)).filter(function() {
                        return 3 !== this.nodeType
                    }), function(status) {
                        callback.call(this, status)
            ...
            _node_changed: function(obj) {
                obj = this.get_node(obj), obj && this._model.changed.push(obj.id)
            },
            _append_html_data: function(dom, data, cb) {
                ...
                for (dat.each($.proxy(function(i, v) {
                        tmp = this._parse_model_from_html($(v), par, p.parents.concat()), tmp && (chd.push(tmp), dpc.push(tmp), m[tmp].children_d.length && (dpc = dpc.concat(m[tmp].children_d)))
            ...
            _append_json_data: function(dom, data, cb, force_processing) {
                if (null !== this.element) {
                    dom = this.get_node(dom), dom.children = [], dom.children_d = [], data.d && (data = data.d, "string" == typeof data && (data = JSON.parse(data))), $.isArray(data) || (data = [data]);
                    var w = null,
                        args = {
                        ...
                        func = function(data, undefined) {
                            ...
                            var tmp, i, j, rslt, dat = data.dat,
                                ...
                                parse_flat = function(d, p, ps) {
                                    ...
                                    for (d && d.children && d.children === !0 && (tmp.state.loaded = !1, tmp.children = [], tmp.children_d = []), m[tmp.id] = tmp, i = 0, j = tmp.children.length; i < j; i++) c = parse_flat(m[tmp.children[i]], tmp.id, ps), e = m[c], tmp.children_d.push(c), e.children_d.length && (tmp.children_d = tmp.children_d.concat(e.children_d));
                                ...
                                parse_nest = function(d, p, ps) {
                                    ...
                                    do tid = "j" + t_id + "_" + ++t_cnt; while (m[tid]);
                                    tmp = {
                                        id: !1,
                                    ...
                                    return d && d.children && d.children === !0 && (tmp.state.loaded = !1, tmp.children = [], tmp.children_d = []), delete d.data, delete d.children, tmp.original = d, m[tmp.id] = tmp, tmp.state.selected && add.push(tmp.id), tmp.id
                                };
                            if (dat.length && dat[0].id !== undefined && dat[0].parent !== undefined) {
                                ...
                                for (i = 0, j = dat.length; i < j; i++) tmp = parse_nest(dat[i], par, p.parents.concat()), tmp && (chd.push(tmp), dpc.push(tmp), m[tmp].children_d.length && (dpc = dpc.concat(m[tmp].children_d)));
                            ...
                            return "undefined" != typeof window && "undefined" != typeof window.document ? rslt : void postMessage(rslt)
                        },
                            ...
                            if (null !== this.element) {
                                if (this._cnt = rslt.cnt, this._model.data = rslt.mod, worker) {
                                    ...
                                    if (r.length !== s.length || $.vakata.array_unique(r.concat(s)).length !== r.length) {
                                        for (i = 0, j = r.length; i < j; i++) $.inArray(r[i], a) === -1 && $.inArray(r[i], s) === -1 && (m[r[i]].state.selected = !1);
                                        for (i = 0, j = s.length; i < j; i++) $.inArray(s[i], r) === -1 && (m[s[i]].state.selected = !0)
                                    }
                                }
            ...
            _parse_model_from_html: function(d, p, ps) {
                ...
                if (tmp = $.vakata.attributes(d, !0), $.each(tmp, function(i, v) {
                        return v = $.trim(v), !v.length || (data.li_attr[i] = v, void("id" === i && (data.id = v.toString())))
                ...
                do tid = "j" + this._id + "_" + ++this._cnt; while (m[tid]);
            ...
            _parse_model_from_flat_json: function(d, p, ps) {
                ...
                if (tmp.li_attr.id || (tmp.li_attr.id = tid), d && "object" == typeof d.a_attr)
                    for (i in d.a_attr) d.a_attr.hasOwnProperty(i) && (tmp.a_attr[i] = d.a_attr[i]);
                for (d && d.children && d.children === !0 && (tmp.state.loaded = !1, tmp.children = [], tmp.children_d = []), m[tmp.id] = tmp, i = 0, j = tmp.children.length; i < j; i++) c = this._parse_model_from_flat_json(m[tmp.children[i]], tmp.id, ps), e = m[c], tmp.children_d.push(c), e.children_d.length && (tmp.children_d = tmp.children_d.concat(e.children_d));
            ...
            _parse_model_from_json: function(d, p, ps) {
                ...
                return d && d.children && d.children === !0 && (tmp.state.loaded = !1, tmp.children = [], tmp.children_d = []), delete d.data, delete d.children, tmp.original = d, m[tmp.id] = tmp, tmp.state.selected && this._data.core.selected.push(tmp.id), tmp.id
            },
            _redraw: function() {
                ...
                for (i = 0, j = nodes.length; i < j; i++) tmp = this.redraw_node(nodes[i], !0, this._model.force_full_redraw), tmp && this._model.force_full_redraw && f.appendChild(tmp);
            ...
            draw_children: function(node) {
                ...
                if (node = this.get_node(node, !0), !node || !node.length) return !1;
            ...
            redraw_node: function(node, deep, is_callback, force_render) {
                ...
                if (deep = deep || 0 === obj.children.length, node = document.querySelector ? this.element[0].querySelector("#" + ("0123456789".indexOf(obj.id[0]) !== -1 ? "\\3" + obj.id[0] + " " + obj.id.substr(1).replace($.jstree.idregex, "\\$&") : obj.id.replace($.jstree.idregex, "\\$&"))) : document.getElementById(obj.id)) node = $(node), is_callback || (par = node.parent().parent()[0], par === this.element[0] && (par = null), ind = node.index()), deep || !obj.children.length || node.children(".jstree-children").length || (deep = !0), deep || (old = node.children(".jstree-children")[0]), f = node.children(".jstree-anchor")[0] === document.activeElement, node.remove();
                    ...
                    if (par = "#" !== obj.parent ? $("#" + obj.parent.replace($.jstree.idregex, "\\$&"), this.element)[0] : null, !(null === par || par && m[obj.parent].state.opened)) return !1;
            ...
            open_node: function(obj, callback, animation) {
                ...
                if (obj = this.get_node(obj), !obj || "#" === obj.id) return !1;
            ...
            is_disabled: function(obj) {
                return obj = this.get_node(obj), obj && obj.state && obj.state.disabled
            },
            enable_node: function(obj) {
                ...
                return obj = this.get_node(obj), !(!obj || "#" === obj.id) && (obj.state.disabled = !1, this.get_node(obj, !0).children(".jstree-anchor").removeClass("jstree-disabled").attr("aria-disabled", !1), void this.trigger("enable_node", {
                    node: obj
                }))
            },
            disable_node: function(obj) {
                ...
                return obj = this.get_node(obj), !(!obj || "#" === obj.id) && (obj.state.disabled = !0, this.get_node(obj, !0).children(".jstree-anchor").addClass("jstree-disabled").attr("aria-disabled", !0), void this.trigger("disable_node", {
                    node: obj
                }))
            },
            ...
            hover_node: function(obj) {
                if (obj = this.get_node(obj, !0), !obj || !obj.length || obj.children(".jstree-hovered").length) return !1;
            ...
            dehover_node: function(obj) {
                return obj = this.get_node(obj, !0), !!(obj && obj.length && obj.children(".jstree-hovered").length) && (obj.children(".jstree-anchor").removeClass("jstree-hovered"), void this.trigger("dehover_node", {
                    node: this.get_node(obj)
                }))
            },
            select_node: function(obj, supress_event, prevent_open, e) {
                ...
                return obj = this.get_node(obj), !(!obj || "#" === obj.id) && (dom = this.get_node(obj, !0), void(obj.state.selected || (obj.state.selected = !0, this._data.core.selected.push(obj.id), prevent_open || (dom = this._open_to(obj)), dom && dom.length && dom.attr("aria-selected", !0).children(".jstree-anchor").addClass("jstree-clicked"), this.trigger("select_node", {
                    node: obj,
                    selected: this._data.core.selected,
                    event: e
            ...
            deselect_node: function(obj, supress_event, e) {
                ...
                return obj = this.get_node(obj), !(!obj || "#" === obj.id) && (dom = this.get_node(obj, !0), void(obj.state.selected && (obj.state.selected = !1, this._data.core.selected = $.vakata.array_remove_item(this._data.core.selected, obj.id), dom.length && dom.attr("aria-selected", !1).children(".jstree-anchor").removeClass("jstree-clicked"), this.trigger("deselect_node", {
                    node: obj,
                    selected: this._data.core.selected,
                    event: e
                }), supress_event || this.trigger("changed", {
            ...
            is_selected: function(obj) {
                return obj = this.get_node(obj), !(!obj || "#" === obj.id) && obj.state.selected
            },
            ...
            set_state: function(state, callback) {
                if (state) {
                    if (state.core) {
                        ...
                        for (i in state) state.hasOwnProperty(i) && "core" !== i && $.inArray(i, this.settings.plugins) === -1 && delete state[i];
            ...
            refresh: function(skip_loading, forget_state) {
                this._data.core.state = forget_state === !0 ? {} : this.get_state(), forget_state && $.isFunction(forget_state) && (this._data.core.state = forget_state.call(this, this._data.core.state)), this._cnt = 0, this._model.data = {
                    "#": {
                        id: "#",
                        parent: null,
                        parents: [],
            ...
            refresh_node: function(obj) {
                ...
                to_load.push(obj.id), obj.state.opened === !0 && opened.push(obj.id), this.get_node(obj, !0).find(".jstree-open").each(function() {
                    opened.push(this.id)
            ...
            set_text: function(obj, val) {
                ...
                return obj = this.get_node(obj), !(!obj || "#" === obj.id) && (obj.text = val, this.get_node(obj, !0).length && this.redraw_node(obj.id), this.trigger("set_text", {
                    obj: obj,
                    text: val
                }), !0)
            },
            get_json: function(obj, options, flat) {
                if (obj = this.get_node(obj || "#"), !obj) return !1;
            ...
            create_node: function(par, node, pos, callback, is_loaded) {
                if (null === par && (par = "#"), par = this.get_node(par), !par) return !1;
                ...
                if (node.id === !0 && delete node.id, node = this._parse_model_from_json(node, par.id, par.parents.concat()), !node) return !1;
            ...
            rename_node: function(obj, val) {
                ...
                return obj = this.get_node(obj), !(!obj || "#" === obj.id) && (old = obj.text, this.check("rename_node", obj, this.get_parent(obj), val) ? (this.set_text(obj, val), this.trigger("rename_node", {
                    node: obj,
                    text: val,
                    old: old
            ...
            delete_node: function(obj) {
                ...
                for (pos !== -1 && (par.children = $.vakata.array_remove(par.children, pos)), tmp = obj.children_d.concat([]), tmp.push(obj.id), k = 0, l = tmp.length; k < l; k++) {
                    for (i = 0, j = obj.parents.length; i < j; i++) pos = $.inArray(tmp[k], this._model.data[obj.parents[i]].children_d), pos !== -1 && (this._model.data[obj.parents[i]].children_d = $.vakata.array_remove(this._model.data[obj.parents[i]].children_d, pos));
                    this._model.data[tmp[k]].state.selected && (c = !0, pos = $.inArray(tmp[k], this._data.core.selected), pos !== -1 && (this._data.core.selected = $.vakata.array_remove(this._data.core.selected, pos)))
                }
            ...
            check: function(chk, obj, par, pos, more) {
                ...
                return "move_node" !== chk && "copy_node" !== chk || more && more.is_multi || obj.id !== par.id && $.inArray(obj.id, par.children) !== pos && $.inArray(par.id, obj.children_d) === -1 ? (tmp && tmp.data && (tmp = tmp.data), tmp && tmp.functions && (tmp.functions[chk] === !1 || tmp.functions[chk] === !0) ? (tmp.functions[chk] === !1 && (this._data.core.last_error = {
                    error: "check",
                    plugin: "core",
                    id: "core_02",
                ...
                }), tmp.functions[chk]) : !(chc === !1 || $.isFunction(chc) && chc.call(this, chk, obj, par, pos, more) === !1 || chc && chc[chk] === !1) || (this._data.core.last_error = {
                    error: "check",
                    plugin: "core",
                    id: "core_03",
            ...
            move_node: function(obj, par, pos, callback, is_loaded, skip_redraw, origin) {
                ...
                if (obj = obj && obj.id ? obj : this.get_node(obj), !obj || "#" === obj.id) return !1;
                ...
                if (obj.parent === new_par.id) {
                    for (dpc = new_par.children.concat(), tmp = $.inArray(obj.id, dpc), tmp !== -1 && (dpc = $.vakata.array_remove(dpc, tmp), pos > tmp && pos--), tmp = [], i = 0, j = dpc.length; i < j; i++) tmp[i >= pos ? i + 1 : i] = dpc[i];
                    ...
                    for (tmp = obj.children_d.concat(), tmp.push(obj.id), i = 0, j = obj.parents.length; i < j; i++) {
                        for (dpc = [], p = old_ins._model.data[obj.parents[i]].children_d, k = 0, l = p.length; k < l; k++) $.inArray(p[k], tmp) === -1 && dpc.push(p[k]);
                    ...
                    for (dpc[pos] = obj.id, new_par.children = dpc, new_par.children_d.push(obj.id), new_par.children_d = new_par.children_d.concat(obj.children_d), obj.parent = new_par.id, tmp = new_par.parents.concat(), tmp.unshift(new_par.id), p = obj.parents.length, obj.parents = tmp, tmp = tmp.concat(), i = 0, j = obj.children_d.length; i < j; i++) this._model.data[obj.children_d[i]].parents = this._model.data[obj.children_d[i]].parents.slice(0, p * -1), Array.prototype.push.apply(this._model.data[obj.children_d[i]].parents, tmp);
            ...
            copy_node: function(obj, par, pos, callback, is_loaded, skip_redraw, origin) {
                ...
                if (obj = obj && obj.id ? obj : this.get_node(obj), !obj || "#" === obj.id) return !1;
                switch (old_par = (obj.parent || "#").toString(), new_par = pos.toString().match(/^(before|after)$/) && "#" !== par.id ? this.get_node(par.parent) : par, old_ins = origin ? origin : this._model.data[obj.id] ? this : $.jstree.reference(obj.id), is_multi = !old_ins || !old_ins._id || this._id !== old_ins._id, old_ins && old_ins._id && (obj = old_ins._model.data[obj.id]), "#" === par.id && ("before" === pos && (pos = "first"), "after" === pos && (pos = "last")), pos) {
                    case "before":
                        pos = $.inArray(par.id, new_par.children);
                        break;
                    case "after":
                ...
                if (node.id === !0 && delete node.id, node = this._parse_model_from_json(node, new_par.id, new_par.parents.concat()), !node) return !1;
                for (tmp = this.get_node(node), obj && obj.state && obj.state.loaded === !1 && (tmp.state.loaded = !1), dpc = [], dpc.push(node), dpc = dpc.concat(tmp.children_d), this.trigger("model", {
                        nodes: dpc,
                        parent: new_par.id
                ...
                for (dpc = [],
                    i = 0, j = new_par.children.length; i < j; i++) dpc[i >= pos ? i + 1 : i] = new_par.children[i];
            ...
            cut: function(obj) {
                ...
                var o, t1, t2, tmp = [];
                for (t1 = 0, t2 = obj.length; t1 < t2; t1++) o = this.get_node(obj[t1]), o && o.id && "#" !== o.id && tmp.push(o);
                return !!tmp.length && (ccp_node = tmp, ccp_inst = this, ccp_mode = "move_node", void this.trigger("cut", {
                    node: obj
                }))
            },
            copy: function(obj) {
                ...
                var o, t1, t2, tmp = [];
                for (t1 = 0, t2 = obj.length; t1 < t2; t1++) o = this.get_node(obj[t1]), o && o.id && "#" !== o.id && tmp.push(o);
                return !!tmp.length && (ccp_node = tmp, ccp_inst = this, ccp_mode = "copy_node", void this.trigger("copy", {
                    node: obj
                }))
            },
            get_buffer: function() {
            ...
            can_paste: function() {
                return ccp_mode !== !1 && ccp_node !== !1
            },
            paste: function(obj, pos) {
                return obj = this.get_node(obj), !!(obj && ccp_mode && ccp_mode.match(/^(copy_node|move_node)$/) && ccp_node) && (this[ccp_mode](ccp_node, obj, pos, !1, !1, !1, ccp_inst) && this.trigger("paste", {
                    parent: obj.id,
                    node: ccp_node,
                    mode: ccp_mode
                }), ccp_node = !1, ccp_mode = !1, void(ccp_inst = !1))
            },
            ...
            edit: function(obj, default_text, callback) {
                ...
                return !!(obj = this.get_node(obj)) && (this.settings.core.check_callback === !1 ? (this._data.core.last_error = {
                    error: "check",
                    plugin: "core",
                    id: "core_07",
            ...
            hide_icon: function(obj) {
                ...
                return obj = this.get_node(obj), !(!obj || "#" === obj) && (obj.icon = !1, this.get_node(obj, !0).children(".jstree-anchor").children(".jstree-themeicon").addClass("jstree-themeicon-hidden"), !0)
            },
            show_icon: function(obj) {
                ...
                return obj = this.get_node(obj), !(!obj || "#" === obj) && (dom = this.get_node(obj, !0), obj.icon = !dom.length || dom.children(".jstree-anchor").children(".jstree-themeicon").attr("rel"), obj.icon || (obj.icon = !0), dom.children(".jstree-anchor").children(".jstree-themeicon").removeClass("jstree-themeicon-hidden"), !0)
            }
        }, $.vakata = {}, $.vakata.attributes = function(node, with_values) {
            node = $(node)[0];
            var attr = with_values ? {} : [];
            return node && node.attributes && $.each(node.attributes, function(i, v) {
                $.inArray(v.name.toLowerCase(), ["style", "contenteditable", "hasfocus", "tabindex"]) === -1 && null !== v.value && "" !== $.trim(v.value) && (with_values ? attr[v.name] = v.value : attr.push(v.name))
            }), attr
        ...
        _i.className = "jstree-icon jstree-checkbox", _i.setAttribute("role", "presentation"), $.jstree.defaults.checkbox = {
                ...
                this.bind = function() {
                    parent.bind.call(this), this._data.checkbox.uto = !1, this._data.checkbox.selected = [], this.settings.checkbox.three_state && (this.settings.checkbox.cascade = "up+down+undetermined"), this.element.on("init.jstree", $.proxy(function() {
                    ...
                    }, this)), this.settings.checkbox.cascade.indexOf("undetermined") !== -1 && this.element.on("changed.jstree uncheck_node.jstree check_node.jstree uncheck_all.jstree check_all.jstree move_node.jstree copy_node.jstree redraw.jstree open_node.jstree", $.proxy(function() {
                    ...
                    }, this)), this.settings.checkbox.cascade.indexOf("up") === -1 && this.settings.checkbox.cascade.indexOf("down") === -1 || this.element.on("model.jstree", $.proxy(function(e, data) {
                        ...
                        if (s.indexOf("up") !== -1) {
                            ...
                            for (chd = $.vakata.array_unique(chd), k = 0, l = chd.length; k < l; k++)
                                for (p = m[chd[k]]; p && "#" !== p.id;) {
                                    ...
                                    if (c !== j) break;
                                    p.state[t ? "selected" : "checked"] = !0, this._data[t ? "core" : "checkbox"].selected.push(p.id), tmp = this.get_node(p, !0), tmp && tmp.length && tmp.attr("aria-selected", !0).children(".jstree-anchor").addClass(t ? "jstree-clicked" : "jstree-checked"), p = this.get_node(p.parent)
                                }
                        }
                        ...
                        if (s.indexOf("up") !== -1)
                            for (; par && "#" !== par.id;) {
                                ...
                                if (c !== j) break;
                                par.state[t ? "selected" : "checked"] = !0, this._data[t ? "core" : "checkbox"].selected.push(par.id), tmp = this.get_node(par, !0), tmp && tmp.length && tmp.attr("aria-selected", !0).children(".jstree-anchor").addClass(t ? "jstree-clicked" : "jstree-checked"), par = this.get_node(par.parent)
                            }
                        s.indexOf("down") !== -1 && dom.length && dom.find(".jstree-anchor").addClass(t ? "jstree-clicked" : "jstree-checked").parent().attr("aria-selected", !0)
                        ...
                        var i, j, tmp, obj = this.get_node("#"),
                            m = this._model.data;
                        for (i = 0, j = obj.children_d.length; i < j; i++) tmp = m[obj.children_d[i]], tmp && tmp.original && tmp.original.state && tmp.original.state.undetermined && (tmp.original.state.undetermined = !1)
                        ...
                        var i, j, tmp, obj = data.node,
                            ...
                            s = this.settings.checkbox.cascade,
                            t = this.settings.checkbox.tie_selection;
                        if (obj && obj.original && obj.original.state && obj.original.state.undetermined && (obj.original.state.undetermined = !1), s.indexOf("down") !== -1)
                        ...
                        for (tmp = [], i = 0, j = this._data[t ? "core" : "checkbox"].selected.length; i < j; i++) s.indexOf("down") !== -1 && $.inArray(this._data[t ? "core" : "checkbox"].selected[i], obj.children_d) !== -1 || s.indexOf("up") !== -1 && $.inArray(this._data[t ? "core" : "checkbox"].selected[i], obj.parents) !== -1 || tmp.push(this._data[t ? "core" : "checkbox"].selected[i]);
                        this._data[t ? "core" : "checkbox"].selected = $.vakata.array_unique(tmp), s.indexOf("down") !== -1 && dom.length && dom.find(".jstree-anchor").removeClass(t ? "jstree-clicked" : "jstree-checked").parent().attr("aria-selected", !1)
                    }, this)), this.settings.checkbox.cascade.indexOf("up") !== -1 && this.element.on("delete_node.jstree", $.proxy(function(e, data) {
                        ...
                        for (p = new_par; p && "#" !== p.id;) {
                            for (c = 0, i = 0, j = p.children.length; i < j; i++) c += m[p.children[i]].state[t ? "selected" : "checked"];
                            if (c === j) p.state[t ? "selected" : "checked"] || (p.state[t ? "selected" : "checked"] = !0, this._data[t ? "core" : "checkbox"].selected.push(p.id), tmp = this.get_node(p, !0), tmp && tmp.length && tmp.attr("aria-selected", !0).children(".jstree-anchor").addClass(t ? "jstree-clicked" : "jstree-checked"));
                            else {
                                if (!p.state[t ? "selected" : "checked"]) break;
                                p.state[t ? "selected" : "checked"] = !1, this._data[t ? "core" : "checkbox"].selected = $.vakata.array_remove_item(this._data[t ? "core" : "checkbox"].selected, p.id), tmp = this.get_node(p, !0), tmp && tmp.length && tmp.attr("aria-selected", !1).children(".jstree-anchor").removeClass(t ? "jstree-clicked" : "jstree-checked")
                            }
                        ...
                        for (this.element.find(".jstree-closed").not(":has(.jstree-children)").each(function() {
                                ...
                                if (tmp.state.loaded) {
                                    for (i = 0, j = tmp.children_d.length; i < j; i++)
                                        if (tmp2 = m[tmp.children_d[i]], !tmp2.state.loaded && tmp2.original && tmp2.original.state && tmp2.original.state.undetermined && tmp2.original.state.undetermined === !0)
                                ...
                                } else if (tmp.original && tmp.original.state && tmp.original.state.undetermined && tmp.original.state.undetermined === !0)
                            ...
                            }), this.element.find(".jstree-undetermined").removeClass("jstree-undetermined"), i = 0, j = p.length; i < j; i++) m[p[i]].state[t ? "selected" : "checked"] || (s = this.get_node(p[i], !0), s && s.length && s.children(".jstree-anchor").children(".jstree-checkbox").addClass("jstree-undetermined"))
                    }
                    ...
                    return is_callback || this.settings.checkbox.cascade.indexOf("undetermined") === -1 || (this._data.checkbox.uto && clearTimeout(this._data.checkbox.uto), this._data.checkbox.uto = setTimeout($.proxy(this._undetermined, this), 50)), obj
                    ...
                    var i, j, s = this.settings.checkbox.cascade,
                        ...
                        m = this._model.data;
                    if (!obj || obj.state[t ? "selected" : "checked"] === !0 || s.indexOf("undetermined") === -1 || s.indexOf("down") === -1 && s.indexOf("up") === -1) return !1;
                    if (!obj.state.loaded && obj.original.state.undetermined === !0) return !0;
                    for (i = 0, j = obj.children_d.length; i < j; i++)
                        if ($.inArray(obj.children_d[i], d) !== -1 || !m[obj.children_d[i]].state.loaded && m[obj.children_d[i]].original.state.undetermined) return !0;
                    return !1
                    ...
                    return obj = this.get_node(obj), !(!obj || "#" === obj.id) && (dom = this.get_node(obj, !0), void(obj.state.checked || (obj.state.checked = !0, this._data.checkbox.selected.push(obj.id), dom && dom.length && dom.children(".jstree-anchor").addClass("jstree-checked"), this.trigger("check_node", {
                        node: obj,
                    ...
                    return obj = this.get_node(obj), !(!obj || "#" === obj.id) && (dom = this.get_node(obj, !0), void(obj.state.checked && (obj.state.checked = !1, this._data.checkbox.selected = $.vakata.array_remove_item(this._data.checkbox.selected, obj.id), dom.length && dom.children(".jstree-anchor").removeClass("jstree-checked"), this.trigger("uncheck_node", {
                        node: obj,
                        selected: this._data.checkbox.selected,
                        event: e
                    }))))
                    ...
                    return this.settings.checkbox.tie_selection ? this.is_selected(obj) : (obj = this.get_node(obj), !(!obj || "#" === obj.id) && obj.state.checked)
                    ...
                    var k, l, c, tmp;
                    if (!$.isArray(obj) && !this.settings.checkbox.tie_selection && (tmp = this.get_node(obj), tmp && tmp.state.loaded))
                        for (k = 0, l = tmp.children_d.length; k < l; k++) this._model.data[tmp.children_d[k]].state.checked && (c = !0, this._data.checkbox.selected = $.vakata.array_remove_item(this._data.checkbox.selected, tmp.children_d[k]));
            ...
            function($) {
                ...
                $.vakata.context = {
                    ...
                    _execute: function(i) {
                        return i = vakata_context.items[i], !(!i || i._disabled && (!$.isFunction(i._disabled) || i._disabled({
                            item: i,
                            reference: vakata_context.reference,
                            element: vakata_context.element
                    ...
                    _parse: function(o, is_callback) {
                        ...
                        return is_callback && (str += "<ul>"), $.each(o, function(i, val) {
                            return !val || (vakata_context.items.push(val), !sep && val.separator_before && (str += "<li class='vakata-context-separator'><a href='#' " + ($.vakata.context.settings.icons ? "" : 'style="margin-left:0px;"') + ">&#160;</a></li>"), sep = !1, str += "<li class='" + (val._class || "") + (val._disabled === !0 || $.isFunction(val._disabled) && val._disabled({
                                item: val,
                                reference: vakata_context.reference,
                                element: vakata_context.element
                            }) ? " vakata-contextmenu-disabled " : "") + "' " + (val.shortcut ? " data-shortcut='" + val.shortcut + "' " : "") + ">", str += "<a href='#' rel='" + (vakata_context.items.length - 1) + "'>", $.vakata.context.settings.icons && (str += "<i ", val.icon && (str += val.icon.indexOf("/") !== -1 || val.icon.indexOf(".") !== -1 ? " style='background:url(\"" + val.icon + "\") center center no-repeat' " : " class='" + val.icon + "' "), str += "></i><span class='vakata-contextmenu-sep'>&#160;</span>"), str += ($.isFunction(val.label) ? val.label({
                                item: i,
                                reference: vakata_context.reference,
                                element: vakata_context.element
                            }) : val.label) + (val.shortcut ? ' <span class="vakata-contextmenu-shortcut vakata-contextmenu-shortcut-' + val.shortcut + '">' + (val.shortcut_label || "") + "</span>" : "") + "</a>", val.submenu && (tmp = $.vakata.context._parse(val.submenu, !0), tmp && (str += tmp)), str += "</li>", void(val.separator_after && (str += "<li class='vakata-context-separator'><a href='#' " + ($.vakata.context.settings.icons ? "" : 'style="margin-left:0px;"') + ">&#160;</a></li>", sep = !0)))
                    ...
                    _show_submenu: function(o) {
                        if (o = $(o), o.length && o.children("ul").length) {
                            ...
                            right_to_left ? o[x - (w + 10 + o.outerWidth()) < 0 ? "addClass" : "removeClass"]("vakata-context-left") : o[x + w + 10 > dw ? "addClass" : "removeClass"]("vakata-context-right"),
                                y + h + 10 > dh && e.css("bottom", "-1px"), e.show()
                        }
                    },
                    show: function(reference, position, data) {
                        var o, e, x, y, w, h, dw, dh, cond = !0;
                        switch (vakata_context.element && vakata_context.element.length && vakata_context.element.width(""), cond) {
                        ...
                        reference && !data && $(reference).data("vakata_contextmenu") && (data = $(reference).data("vakata_contextmenu")), $.vakata.context._parse(data) && vakata_context.element.html(vakata_context.html), vakata_context.items.length && (vakata_context.element.appendTo("body"), e = vakata_context.element, x = vakata_context.position_x, y = vakata_context.position_y, w = e.width(), h = e.height(), dw = $(window).width() + $(window).scrollLeft(), dh = $(window).height() + $(window).scrollTop(), right_to_left && (x -= e.outerWidth() - $(reference).outerWidth(), x < $(window).scrollLeft() + 20 && (x = $(window).scrollLeft() + 20)), x + w + 20 > dw && (x = dw - (w + 20)), y + h + 20 > dh && (y = dh - (h + 20)), vakata_context.element.css({
                            left: x,
                            top: y
                    ...
                    vakata_context.element = $("<ul class='vakata-context'></ul>"), vakata_context.element.on("mouseenter", "li", function(e) {
                        ...
                        e.preventDefault(), $(this).blur().parent().hasClass("vakata-context-disabled") || $.vakata.context._execute($(this).attr("rel")) === !1 || $.vakata.context.hide()
                ...
                this.bind = function() {
                    parent.bind.call(this), this.element.on("mousedown.jstree touchstart.jstree", this.settings.dnd.large_drag_target ? ".jstree-node" : ".jstree-anchor", $.proxy(function(e) {
                        ...
                        return this.settings.core.force_text && (txt = $.vakata.html.escape(txt)), obj && obj.id && "#" !== obj.id && (1 === e.which || "touchstart" === e.type) && (this.settings.dnd.is_draggable === !0 || $.isFunction(this.settings.dnd.is_draggable) && this.settings.dnd.is_draggable.call(this, mlt > 1 ? this.get_top_selected(!0) : [obj])) ? (this.element.trigger("mousedown.jstree"), $.vakata.dnd.start(e, {
                            jstree: !0,
                            origin: this,
                ...
                $(document).on("dnd_start.vakata.jstree", function(e, data) {
                    ...
                    if (opento && clearTimeout(opento), data && data.data && data.data.jstree) {
                        ...
                        } else i = $(data.event.target).closest(".jstree"), i.length && laster && laster.error && "check" === laster.error && (i = i.jstree(!0), i && i.settings.core.error.call(this, laster))
                    }
                }).on("keyup.jstree keydown.jstree", function(e, data) {
                    data = $.vakata.dnd._get(), data && data.data && data.data.jstree && data.helper.find(".jstree-copy").first()[data.data.origin && (data.data.origin.settings.dnd.always_copy || data.data.origin.settings.dnd.copy && (e.metaKey || e.ctrlKey)) ? "show" : "hide"]()
                })
            }),
            function($) {
                $.vakata.html = {
                ...
                $.vakata.dnd = {
                    ...
                    start: function(e, data, html) {
                        ...
                        return vakata_dnd.init_x = e.pageX, vakata_dnd.init_y = e.pageY, vakata_dnd.data = data, vakata_dnd.is_down = !0, vakata_dnd.element = e.currentTarget, vakata_dnd.target = e.target, vakata_dnd.is_touch = "touchstart" === e.type, html !== !1 && (vakata_dnd.helper = $("<div id='vakata-dnd'></div>").html(html).css({
                            display: "block",
                            margin: "0",
                            padding: "0",
                            position: "absolute",
                ...
                this.bind = function() {
                    ...
                    var s = this.settings.search,
                        ...
                        r = [],
                        p = [];
                    return this._data.search.res.length && !append && this.clear_search(), show_only_matches === undefined && (show_only_matches = s.show_only_matches), show_only_matches_children === undefined && (show_only_matches_children = s.show_only_matches_children), skip_async || a === !1 ? (append || (this._data.search.str = str, this._data.search.dom = $(), this._data.search.res = [], this._data.search.opn = [], this._data.search.som = show_only_matches, this._data.search.smc = show_only_matches_children), f = new $.vakata.search(str, !0, {
                        ...
                        return "0123456789".indexOf(v[0]) !== -1 ? "\\3" + v[0] + " " + v.substr(1).replace($.jstree.idregex, "\\$&") : v.replace($.jstree.idregex, "\\$&")
                    }).join(", #"))), this._data.search.res = r), this._data.search.dom.children(".jstree-anchor").addClass("jstree-search")), void this.trigger("search", {
                        nodes: this._data.search.dom,
                        str: str,
                        res: this._data.search.res,
                        show_only_matches: show_only_matches
                    })) : $.isFunction(a) ? a.call(this, str, $.proxy(function(d) {
            ...
            function($) {
                $.vakata.search = function(pattern, txt, options) {
                    options = options || {}, options = $.extend({}, $.vakata.search.defaults, options), options.fuzzy !== !1 && (options.fuzzy = !0), pattern = options.caseSensitive ? pattern : pattern.toLowerCase();
                    ...
                    return patternLen > 32 && (options.fuzzy = !1), options.fuzzy && (matchmask = 1 << patternLen - 1, pattern_alphabet = function() {
                        ...
                        if (text = options.caseSensitive ? text : text.toLowerCase(), pattern === text || text.indexOf(pattern) !== -1) return {
                            isMatch: !0,
                            score: 0
                        };
                        ...
                        var i, j, binMin, binMid, lastRd, start, finish, rd, charMatch, textLen = text.length,
                            ...
                            score = 1,
                            locations = [];
                        for (bestLoc !== -1 && (scoreThreshold = Math.min(match_bitapScore(0, bestLoc), scoreThreshold), bestLoc = text.lastIndexOf(pattern, MATCH_LOCATION + patternLen), bestLoc !== -1 && (scoreThreshold = Math.min(match_bitapScore(0, bestLoc), scoreThreshold))), bestLoc = -1, i = 0; i < patternLen; i++) {
                            ...
                            for (binMax = binMid, start = Math.max(1, MATCH_LOCATION - binMid + 1), finish = Math.min(MATCH_LOCATION + binMid, textLen) + patternLen, rd = new Array(finish + 2), rd[finish + 1] = (1 << i) - 1, j = finish; j >= start; j--)
                                if (charMatch = pattern_alphabet[text.charAt(j - 1)], 0 === i ? rd[j] = (rd[j + 1] << 1 | 1) & charMatch : rd[j] = (rd[j + 1] << 1 | 1) & charMatch | ((lastRd[j + 1] | lastRd[j]) << 1 | 1) | lastRd[j + 1], rd[j] & matchmask && (score = match_bitapScore(i, j - 1), score <= scoreThreshold)) {
                ...
                this.bind = function() {
                    ...
                    var i, j;
                    if (obj = this.get_node(obj), obj && obj.children && obj.children.length && (obj.children.sort($.proxy(this.settings.sort, this)), deep))
        ...
        $.jstree.defaults.state = {
            ...
            function($, undefined) {
                ...
                this.init = function(el, options) {
                    ...
                    this.element.on("model.jstree", $.proxy(function(e, data) {
                        var i, j, m = this._model.data,
                            ...
                            c = "default";
                        for (i = 0, j = dpc.length; i < j; i++) c = "default", m[dpc[i]].original && m[dpc[i]].original.type && t[m[dpc[i]].original.type] && (c = m[dpc[i]].original.type), m[dpc[i]].data && m[dpc[i]].data.jstree && m[dpc[i]].data.jstree.type && t[m[dpc[i]].data.jstree.type] && (c = m[dpc[i]].data.jstree.type), m[dpc[i]].type = c, m[dpc[i]].icon === !0 && t[c].icon !== undefined && (m[dpc[i]].icon = t[c].icon);
                        m["#"].type = "#"
                    ...
                    if (parent.check.call(this, chk, obj, par, pos, more) === !1) return !1;
                    obj = obj && obj.id ? obj : this.get_node(obj), par = par && par.id ? par : this.get_node(par);
                    ...
                    switch (m = m && m._model && m._model.data ? m._model.data : null, chk) {
                        ...
                        case "move_node":
                        case "copy_node":
                            if ("move_node" !== chk || $.inArray(obj.id, par.children) === -1) {
                                if (tmp = this.get_rules(par), tmp.max_children !== undefined && tmp.max_children !== -1 && tmp.max_children === par.children.length) return this._data.core.last_error = {
                                    error: "check",
                                    plugin: "types",
                                    id: "types_01",
                                ...
                                if (tmp.valid_children !== undefined && tmp.valid_children !== -1 && $.inArray(obj.type || "default", tmp.valid_children) === -1) return this._data.core.last_error = {
                                    error: "check",
                                    plugin: "types",
                                    id: "types_02",
                                ...
                                do {
                                    if (tmp.max_depth !== undefined && tmp.max_depth !== -1 && tmp.max_depth < d) return this._data.core.last_error = {
                                        error: "check",
                                        plugin: "types",
                                        id: "types_03",
                    ...
                    return obj = this.get_node(obj), !!obj && (rules ? $.extend({
                        type: obj.type
                    ...
                    return t = this.settings.types, obj = this.get_node(obj), !(!t[type] || !obj) && (old_type = obj.type, old_icon = this.get_icon(obj), obj.type = type, (old_icon === !0 || t[old_type] && t[old_type].icon !== undefined && old_icon === t[old_type].icon) && this.set_icon(obj, t[type].icon === undefined || t[type].icon), !0)
                }
                ...
                this.check = function(chk, obj, par, pos, more) {
                    if (parent.check.call(this, chk, obj, par, pos, more) === !1) return !1;
                    if (obj = obj && obj.id ? obj : this.get_node(obj), par = par && par.id ? par : this.get_node(par), !par || !par.children) return !0;
                    ...
                    switch (s || (n = n.toLowerCase()), chk) {
                        case "delete_node":
                            return !0;
                        case "rename_node":
                            return i = $.inArray(n, c) === -1 || obj.text && obj.text[s ? "toString" : "toLowerCase"]() === n, i || (this._data.core.last_error = {
                                error: "check",
                                plugin: "unique",
                                id: "unique_01",
                        ...
                        case "create_node":
                            return i = $.inArray(n, c) === -1, i || (this._data.core.last_error = {
                                error: "check",
                                plugin: "unique",
                                id: "unique_04",
                                reason: "Child with name " + n + " already exists. Preventing: " + chk,
                        ...
                        case "move_node":
                            return i = obj.parent === par.id && (!more || !more.is_multi) || $.inArray(n, c) === -1, i || (this._data.core.last_error = {
                                error: "check",
                                plugin: "unique",
                                id: "unique_03",
                                reason: "Child with name " + n + " already exists. Preventing: " + chk,
                    ...
                    if (!node || node.text === undefined) {
                        if (null === par && (par = "#"), par = this.get_node(par), !par) return parent.create_node.call(this, par, node, pos, callback, is_loaded);
                        ...
                        for (i = 1; $.inArray(s ? n : n.toLowerCase(), dpc) !== -1;) n = cb.call(this, tmp, ++i).toString();
                        node.text = n
                    }
        ...
        if (div.setAttribute("unselectable", "on"), div.setAttribute("role", "presentation"), div.className = "jstree-wholerow", div.innerHTML = "&#160;", $.jstree.plugins.wholerow = function(options, parent) {
                this.bind = function() {
                    parent.bind.call(this), this.element.on("ready.jstree set_state.jstree", $.proxy(function() {
                        ...
                        this.element.find(".jstree-wholerow-clicked").removeClass("jstree-wholerow-clicked");
                        var i, j, tmp = !1;
                        for (i = 0, j = data.selected.length; i < j; i++) tmp = this.get_node(data.selected[i], !0), tmp && tmp.length && tmp.children(".jstree-wholerow").addClass("jstree-wholerow-clicked")
                    ...
                    if (obj = parent.redraw_node.apply(this, arguments)) {
                        var tmp = div.cloneNode(!0);
                        $.inArray(obj.id, this._data.core.selected) !== -1 && (tmp.className += " jstree-wholerow-clicked"), this._data.core.focused && this._data.core.focused === obj.id && (tmp.className += " jstree-wholerow-hovered"), obj.insertBefore(tmp, obj.childNodes[0])
                    }
                    return obj
                }
